...
export class AWSEntityProvider implements EntityProvider {
  ...
  public run(_dynamicAccountConfig?: DynamicAccountConfig): Promise<void> {
    throw new Error('Method not implemented.');
  }
  ...
  protected async getCredentialsProvider(): Promise<() => any> {
