# Contributing to the Backstage GitHub Pull Requests plugin

We want the Backstage GitHub Pull Requests plugin to become the best possible GitHub Pull Requests plugin for Backstage. This is an ambitious goal, and we can't do it without the support of the community.
