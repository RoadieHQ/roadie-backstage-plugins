# Contributing to the Backstage GitHub Insights plugin

We want the Backstage GitHub Insights plugin to become the best possible GitHub Insights plugin for Backstage. This is an ambitious goal, and we can't do it without the support of the community.
...
The Backstage GitHub Insights plugin is released under the Apache 2.0 License, and original creations contributed to this repo are accepted under the same license.
...
No one likes bugs. Report bugs as an issue [here](https://github.com/RoadieHQ/backstage-plugin-github-insights/issues/new?assignees=&labels=bug&template=bug_template.md).
...
The best way to send feedback is to file [an issue](https://github.com/RoadieHQ/backstage-plugin-github-insights/issues/new).
...
Have you started using the Backstage GitHub Insights plugin. Adding your company to [ADOPTERS](https://github.com/RoadieHQ/backstage-plugin-github-insights/blob/main/ADOPTERS.md) really helps the project.
...
See [SECURITY.md](https://github.com/RoadieHQ/backstage-plugin-github-insights/blob/main/SECURITY.md)
