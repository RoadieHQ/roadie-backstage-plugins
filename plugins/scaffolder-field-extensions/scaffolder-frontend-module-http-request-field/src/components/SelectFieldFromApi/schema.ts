...
export const selectFieldFromApiSchema = z.object({
  params: z
    ...
    .optional(),
  path: z.string(),
  arraySelector: z.union([z.string(), z.array(z.string())]).optional(),
  valueSelector: z.union([z.string(), z.array(z.string())]).optional(),
  labelSelector: z.union([z.string(), z.array(z.string())]).optional(),
